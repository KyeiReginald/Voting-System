 ...
 <!-- Add a Print button -->
        ...
        <script>
            function printDashboard() {
                ...
                // Show the print button after printing is complete
                if (printButton) {
        ...
        <!-- Add a print-specific stylesheet to hide the navigation bar -->
        <style media="print">
            /* Replace .navbar with the appropriate selector for your navbar */
            .navbar {
			...
			<div class="card">
				<div class="card-body">
					...
					?>
   					 ...
   					 <div class="img-field">
					 <img src="assets/img/<?php echo $candidate['image_path'] ?>" alt=""> <!-- Adjust width and height as needed -->
					 </div>
...
<?php if($_SESSION['login_type'] == 2): ?>
	...
	<div>
		...
		<h1 style="text-align: center; text-decoration: underline;">Well done</h1>
		<h2>Thankfulness for maintaining that very spirit of democracy, by actually casting your very vote; which actually holds so very much importance. </h2></br>
		<h1>Please wait patiently for the results.</h1>
		<img src="https://my.lwv.org/sites/default/files/styles/slideshow_image/public/leagues/hudson/thanku.png?itok=Y9CBFX2W" width="90%" alt="Thank you for voting">
	</div>
